function hasTargetSum(array, target) {
  ...
  */
  ...
  The i represents one of numbers in an array and j represents another one in which the loop iterates over it to ensure the target is met which after iteration returns true or false
  */
